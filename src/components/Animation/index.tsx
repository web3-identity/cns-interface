export const clipRect = {
  ...
  enter: {
    clipPath: 'inset(0% round 0% 0%)',
    config: { mass: 1, tension: 180, friction: 24 },
  },
  leave: {
    clipPath: 'inset(50% round 50% 50%)',
...
export const clipRectSp = {
  from: {
    clipPath: 'polygon(50% 20%, 50% 50%, 20% 50%, 50% 50%, 50% 80%, 50% 50%, 80% 50%, 50% 50%)',
  },
  enter: {
    clipPath: 'polygon(50% 0%, 0% 0%, 0% 50%, 0% 100%, 50% 100%, 100% 100%, 100% 50%, 100% 0%)',
    config: { mass: 1, tension: 180, friction: 24 },
  },
  leave: {
    clipPath: 'polygon(50% 20%, 50% 50%, 20% 50%, 50% 50%, 50% 80%, 50% 50%, 80% 50%, 50% 50%)',
    config: { mass: 1, tension: 240, friction: 22, clamp: true },
  },
};
...
export const blur = {
  ...
  leave: {
    filter: 'blur(8px)',
    config: { mass: 1, tension: 240, friction: 24, clamp: true },
  },
};
