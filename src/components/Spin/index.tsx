  ...
  return (
    <span className={cx('relative block w-1em h-1em leading-1em', className)}>
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 200 200" xmlSpace="preserve">
        <g className="spin">
          <linearGradient id={rightId} gradientUnits="userSpaceOnUse" x1="150" y1="20" x2="150" y2="180">
            <stop offset="0" style={{ stopColor: theme === 'light' ? '#F0EEE9' : '#6667ab' }} />
            <stop offset="1" style={{ stopColor: theme === 'light' ? '#B1B1B1' : '#8B8BBA' }} />
          </linearGradient>
          <path style={{ fill: `url(#${rightId})`}} d="M100,0v20c44.1,0,80,35.9,80,80c0,44.1-35.9,80-80,80v20c55.2,0,100-44.8,100-100S155.2,0,100,0z" />
          <linearGradient id={leftId} gradientUnits="userSpaceOnUse" x1="50" y1="0" x2="50" y2="180">
            <stop offset="0" style={{ stopColor: theme === 'light' ? '#8B8BBA' : '#B1B1B1' }} />
            <stop offset="1" style={{ stopColor: theme === 'light' ? '#B1B1B1' : '#8B8BBA' }} />
          </linearGradient>
          <path style={{ fill: `url(#${leftId})`}} d="M20,100c0-44.1,35.9-80,80-80V0C44.8,0,0,44.8,0,100s44.8,100,100,100v-20C55.9,180,20,144.1,20,100z" />
