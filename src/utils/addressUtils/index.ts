...
import {
  validateCfxAddress as _validateCfxAddress,
  validateHexAddress as _validateHexAddress,
  validateCNSAddress as _validateCNSAddress,
  toHex as _toHex,
...
export const validateCNSAddress = LRUCacheFunction(_validateCNSAddress, 'validateCNSAddress');
