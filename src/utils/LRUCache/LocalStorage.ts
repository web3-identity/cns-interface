type Data = string | number | boolean | undefined | null | Object | any;
...
function createLocalStorage(): LocalStorage {
  ...
  Object.getOwnPropertyNames(LocalStorage).forEach(<T extends keyof LocalStorage>(func: string) => ((LocalStorage[func as T] as any) = LocalStorage[func as T].bind(LocalStorage)));
