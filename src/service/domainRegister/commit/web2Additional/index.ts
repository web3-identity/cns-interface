 ...
 * The api of backend
 */
export const postCommitmentToBackend = (commitmentHash: string, params: Array<any>) =>
  fetchApi({ path: 'commits', method: 'POST', params: generateCommitmentParams(commitmentHash, params) });
